...
public class IndentableTextView extends TextView {
    ...
    int inTextHorizontalOffsetInPx = UtilsShared.dpToPx(getContext(), TEXT_HORIZONTAL_OFFSET_IN_DP);

    private void init() {

        fltLineWidthInDp = UtilsShared.dpToPx(getContext(), getResources().getInteger(R.integer.treeview_select_line_width_in_dp));
        intRadiusDefaultInPx = UtilsShared.dpToPx(getContext(), getResources().getInteger(R.integer.treeview_indent_radius_in_dp));
    ...
    public void setProperties(Treeview.ListViewListItem listViewListItem,
        ...
        paintPlainBlack.setTextSize(UtilsShared.spToPx(getContext(), intTextSizeInSp));

        fltRadiusInPx = (float) UtilsShared.dpToPx(getContext(), intIndentRadiusInDp);
